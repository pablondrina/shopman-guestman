...
Customer relationship management with loyalty and insights.
...
**Domain:** Clientes
**Namespace:** `shopman.guestman`
**Pip package:** `shopman-guestman`

### Main Models

Customer, ContactPoint, CustomerGroup, LoyaltyAccount
...
This package is developed in the [django-shopman](https://github.com/pablondrina/django-shopman) monorepo under `packages/guestman/`.
